# Plan
Purpose: tell the Codex coding agent how to use `plans/skills/skill-notion-spec-to-implementation.md` as a runtime-pack surface and when to stop browsing.

You must use this plan when applying or updating the `notion-spec-to-implementation` skill.
...
## Inputs
- You must use skill notion-spec-to-implementation.
