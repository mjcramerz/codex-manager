# Plan
Purpose: tell the Codex coding agent how to use `plans/skills/skill-ci-github-actions-fix.md` as a runtime-pack surface and when to stop browsing.

You must use this plan when applying or updating the `ci-github-actions-fix` skill.
