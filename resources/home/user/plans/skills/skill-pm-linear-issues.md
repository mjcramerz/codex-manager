# Plan
Purpose: tell the Codex coding agent how to use `plans/skills/skill-pm-linear-issues.md` as a runtime-pack surface and when to stop browsing.

You must use this plan when applying or updating the `pm-linear-issues` skill.
...
## Inputs
- You must use skill pm-linear-issues.
