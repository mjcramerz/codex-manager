# Plan
Purpose: tell the Codex coding agent how to use `plans/skills/skill-devtools-app-scaffolder.md` as a runtime-pack surface and when to stop browsing.

You must use this plan when applying or updating the `devtools-app-scaffolder` skill.
...
## Inputs
- You must use skill devtools-app-scaffolder.
