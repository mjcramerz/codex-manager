# Plan
Purpose: tell the Codex coding agent how to use `plans/skills/skill-github-pr-comments.md` as a runtime-pack surface and when to stop browsing.

You must use this plan when applying or updating the `github-pr-comments` skill.
...
## Inputs
- You must use skill github-pr-comments.
