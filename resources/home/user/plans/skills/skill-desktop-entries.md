# Plan
Purpose: tell the Codex coding agent how to use `plans/skills/skill-desktop-entries.md` as a runtime-pack surface and when to stop browsing.

You must use this plan when applying or updating the `desktop-entries` skill.
