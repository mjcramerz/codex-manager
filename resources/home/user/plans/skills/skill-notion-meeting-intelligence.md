# Plan
Purpose: tell the Codex coding agent how to use `plans/skills/skill-notion-meeting-intelligence.md` as a runtime-pack surface and when to stop browsing.

You must use this plan when applying or updating the `notion-meeting-intelligence` skill.
...
## Inputs
- You must use skill notion-meeting-intelligence.
