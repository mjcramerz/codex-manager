# Plan
Purpose: tell the Codex coding agent how to use `plans/skills/skill-notion-research-documentation.md` as a runtime-pack surface and when to stop browsing.

You must use this plan when applying or updating the `notion-research-documentation` skill.
...
## Inputs
- You must use skill notion-research-documentation.
