# Plan
Purpose: tell the Codex coding agent how to use `plans/skills/skill-obsidian-toc.md` as a runtime-pack surface and when to stop browsing.

You must use this plan when applying or updating the `obsidian-toc` skill.
...
## Inputs
- You must use skill obsidian-toc.
