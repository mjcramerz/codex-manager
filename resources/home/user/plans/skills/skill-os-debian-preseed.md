# Plan
Purpose: tell the Codex coding agent how to use `plans/skills/skill-os-debian-preseed.md` as a runtime-pack surface and when to stop browsing.

You must use this plan when applying or updating the `os-debian-preseed` skill.
