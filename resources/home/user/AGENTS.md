...
- Source-managed memory router: `resources/home/user/memories/MEMORY.md`.
...
- `resources/home/user/memories/MEMORY.md` is the memory-entry router for repo-aware work.
...
- `UNIX.md` is a compatibility entrypoint; keep the deeper shell guidance in `docs/style/shell-runtime.md` and the language-specific style guides.
