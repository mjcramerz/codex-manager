...
Purpose: stable link to Terraform guidance, workflows, and templates.
...
Canonical content: `$CODEX_HOME/docs/infra/terraform.md`

Use when:
- authoring or reviewing Terraform modules
