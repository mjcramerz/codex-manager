...
You must start with `$CODEX_HOME/plans/workflows/workflow-gitlab-runner.md` before executing this workflow.
Purpose: guide GitLab Runner host and executor changes with explicit service-account, runner-tag, and persistent-state boundaries for the Codex coding agent.
