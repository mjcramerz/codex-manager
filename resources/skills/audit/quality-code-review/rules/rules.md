...
## Required checks
- Follow the workflow in `$CODEX_SKILLS/audit/quality-code-review/SKILL.md`.
- Prefer deterministic scripts in `$CODEX_SKILLS/audit/quality-code-review/scripts/`.
- Use references in `$CODEX_SKILLS/audit/quality-code-review/references/` for factual guidance.
