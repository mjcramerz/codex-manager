#!/usr/bin/env python3
"""Utility helper for the hook-behavior-audit skill."""
...
SKILL_NAME = 'hook-behavior-audit'
SKILL_CATEGORY = 'AUDIT'
SKILL_DESCRIPTION = 'Audit startup/resume/stop hooks and lifecycle guardrails'
LAST_REFRESH_UTC = '2026-03-12'
REFERENCE_LINKS = [
        {'title': 'JSON Schema', 'url': 'https://json-schema.org/', 'note': 'JSON Schema'},
        {'title': 'ShellCheck', 'url': 'https://www.shellcheck.net/', 'note': 'ShellCheck'}
]
