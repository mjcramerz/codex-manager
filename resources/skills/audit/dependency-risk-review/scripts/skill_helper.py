#!/usr/bin/env python3
"""Utility helper for the dependency-risk-review skill."""
...
SKILL_NAME = 'dependency-risk-review'
SKILL_CATEGORY = 'AUDIT'
SKILL_DESCRIPTION = 'Audit dependency risk, pinning, and supply-chain exposure'
LAST_REFRESH_UTC = '2026-03-12'
REFERENCE_LINKS = [
        {'title': 'SLSA', 'url': 'https://slsa.dev/', 'note': 'SLSA'},
        {'title': 'OWASP Dependency-Check', 'url': 'https://owasp.org/www-project-dependency-check/', 'note': 'OWASP Dependency-Check'},
        {'title': 'NIST SSDF', 'url': 'https://csrc.nist.gov/pubs/sp/800/218/final', 'note': 'NIST SSDF'}
]
