#!/usr/bin/env python3
"""Utility helper for the cli-design skill."""
...
SKILL_NAME = 'cli-design'
SKILL_CATEGORY = 'COMMON'
SKILL_DESCRIPTION = 'Design CLI contracts, flags, and exit semantics cleanly'
LAST_REFRESH_UTC = '2026-03-12'
REFERENCE_LINKS = [
        {'title': 'argparse', 'url': 'https://docs.python.org/3/library/argparse.html', 'note': 'argparse'},
        {'title': 'Click documentation', 'url': 'https://click.palletsprojects.com/', 'note': 'Click documentation'},
        {'title': 'clap', 'url': 'https://docs.rs/clap/latest/clap/', 'note': 'clap'}
]
