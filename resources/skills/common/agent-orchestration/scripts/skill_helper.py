#!/usr/bin/env python3
"""Utility helper for the agent-orchestration skill."""
...
SKILL_DESCRIPTION = 'Plan and reconcile multi-agent coding work'
...
REFERENCE_LINKS = [
        ...
        {'title': 'OpenAI tools guide', 'url': 'https://platform.openai.com/docs/guides/tools', 'note': 'OpenAI tools guide'}
]
