#!/usr/bin/env python3
"""Utility helper for the mcp-integration-audit skill."""
...
SKILL_NAME = 'mcp-integration-audit'
SKILL_CATEGORY = 'AUDIT'
SKILL_DESCRIPTION = 'Audit MCP auth, timeouts, and dependency wiring'
LAST_REFRESH_UTC = '2026-03-12'
REFERENCE_LINKS = [
        {'title': 'Model Context Protocol', 'url': 'https://modelcontextprotocol.io/introduction', 'note': 'Model Context Protocol'},
        {'title': 'OAuth 2.0', 'url': 'https://www.rfc-editor.org/rfc/rfc6749', 'note': 'OAuth 2.0'}
]
