#!/usr/bin/env python3
"""Utility helper for the parser-design skill."""
...
SKILL_NAME = 'parser-design'
SKILL_CATEGORY = 'COMMON'
SKILL_DESCRIPTION = 'Design parsers, grammars, and AST transforms safely'
LAST_REFRESH_UTC = '2026-03-12'
REFERENCE_LINKS = [
        {'title': 'Lark parser', 'url': 'https://lark-parser.readthedocs.io/', 'note': 'Lark parser'},
        {'title': 'Tree-sitter', 'url': 'https://tree-sitter.github.io/tree-sitter/', 'note': 'Tree-sitter'},
        {'title': 'Python re module', 'url': 'https://docs.python.org/3/library/re.html', 'note': 'Python re module'}
]
