#!/usr/bin/env python3
"""Utility helper for the installer-regression-audit skill."""
...
SKILL_NAME = 'installer-regression-audit'
SKILL_CATEGORY = 'AUDIT'
SKILL_DESCRIPTION = 'Audit installer flows for regressions and permission drift'
LAST_REFRESH_UTC = '2026-03-12'
REFERENCE_LINKS = [
        {'title': 'NIST SSDF', 'url': 'https://csrc.nist.gov/pubs/sp/800/218/final', 'note': 'NIST SSDF'},
        {'title': 'The Twelve-Factor App', 'url': 'https://12factor.net/', 'note': 'The Twelve-Factor App'}
]
