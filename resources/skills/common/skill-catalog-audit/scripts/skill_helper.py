#!/usr/bin/env python3
"""Utility helper for the skill-catalog-audit skill."""
...
SKILL_NAME = 'skill-catalog-audit'
SKILL_CATEGORY = 'AUDIT'
SKILL_DESCRIPTION = 'Audit skill metadata, routing coverage, and bundle mapping'
LAST_REFRESH_UTC = '2026-03-12'
REFERENCE_LINKS = [
        {'title': 'JSON Schema', 'url': 'https://json-schema.org/', 'note': 'JSON Schema'},
        {'title': 'YAML 1.2.2', 'url': 'https://yaml.org/spec/1.2.2/', 'note': 'YAML 1.2.2'}
]
