...
## Required checks
- Follow the workflow in `$CODEX_SKILLS/common/repo-bash-ops/SKILL.md`.
- Prefer deterministic scripts in `$CODEX_SKILLS/common/repo-bash-ops/scripts/`.
- Use references in `$CODEX_SKILLS/common/repo-bash-ops/references/` for factual guidance.
