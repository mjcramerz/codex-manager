#!/usr/bin/env python3
"""Utility helper for the test-strategy skill."""
...
SKILL_DESCRIPTION = 'Map code changes to focused tests and regression checks'
LAST_REFRESH_UTC = '2026-03-12'
REFERENCE_LINKS = [
        {'title': 'pytest docs', 'url': 'https://docs.pytest.org/', 'note': 'pytest docs'},
        {'title': 'unittest', 'url': 'https://docs.python.org/3/library/unittest.html', 'note': 'unittest'},
        {'title': 'cargo test', 'url': 'https://doc.rust-lang.org/cargo/commands/cargo-test.html', 'note': 'cargo test'}
]
