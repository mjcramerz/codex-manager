#!/usr/bin/env python3
"""Utility helper for the desktop-entries skill.
...
SKILL_NAME = 'desktop-entries'
SKILL_CATEGORY = 'DESKTOP'
SKILL_DESCRIPTION = 'Create safe and consistent .desktop launchers.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'Desktop entry spec latest', 'url': 'https://specifications.freedesktop.org/desktop-entry-spec/latest-single/', 'note': 'Detailed launcher key requirements.'}
]
