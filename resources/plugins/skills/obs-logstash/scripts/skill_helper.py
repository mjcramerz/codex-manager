#!/usr/bin/env python3
"""Utility helper for the obs-logstash skill.
...
SKILL_NAME = 'obs-logstash'
SKILL_CATEGORY = 'OBS'
SKILL_DESCRIPTION = 'Design Logstash pipelines with safe input validation.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'Logstash docs', 'url': 'https://www.elastic.co/guide/en/logstash/current/index.html', 'note': 'Pipeline, filter, and output plugin behavior.'}
]
