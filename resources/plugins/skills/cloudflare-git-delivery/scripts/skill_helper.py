#!/usr/bin/env python3
        """Utility helper for the cloudflare-git-delivery skill."""
        ...
        SKILL_NAME = 'cloudflare-git-delivery'
        SKILL_CATEGORY = 'CLOUD'
        SKILL_DESCRIPTION = 'Coordinate cf-git-cicd-worker and delivery shared CI templates so runtime behavior, secrets, routes, D1, and WAF contracts stay aligned.'
        ...
        REFERENCE_LINKS = [
  {
    "title": "https://developers.cloudflare.com/workers/",
