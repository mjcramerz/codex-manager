#!/usr/bin/env python3
"""Utility helper for the infra-grub skill.
...
SKILL_NAME = 'infra-grub'
SKILL_CATEGORY = 'INFRA'
SKILL_DESCRIPTION = 'Safely modify GRUB configuration and kernel parameters.'
...
REFERENCE_LINKS = [{'title': 'GNU GRUB manual', 'url': 'https://www.gnu.org/software/grub/manual/grub/grub.html', 'note': 'Authoritative GRUB behavior, commands, and configuration semantics.'}, {'title': 'GRUB project site', 'url': 'https://www.gnu.org/software/grub/', 'note': 'Release stream and project-maintained guidance.'}, {'title': 'Kernel command line docs', 'url': 'https://docs.kernel.org/admin-guide/kernel-parameters.html', 'note': 'Parameter effects and safety considerations before boot flag changes.'}]
