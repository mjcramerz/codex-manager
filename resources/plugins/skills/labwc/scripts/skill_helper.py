#!/usr/bin/env python3
"""Utility helper for the labwc skill."""
...
SKILL_NAME = 'labwc'
SKILL_CATEGORY = 'Labwc'
SKILL_DESCRIPTION = 'Configure Labwc sessions with explicit compositor, autostart, lock, and launcher policy. Use when the user asks about Labwc behavior, config layout, or session helper scripts.'
...
REFERENCE_LINKS = [
  {
    "title": "https://labwc.github.io/",
    "url": "https://labwc.github.io/",
    "note": "Primary reference."
  },
  {
    "title": "https://github.com/labwc/labwc",
