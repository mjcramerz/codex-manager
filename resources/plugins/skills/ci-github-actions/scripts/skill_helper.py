#!/usr/bin/env python3
"""Utility helper for the ci-github-actions skill.
...
SKILL_NAME = 'ci-github-actions'
SKILL_CATEGORY = 'GIT'
SKILL_DESCRIPTION = 'Build robust GitHub Actions pipelines with security gates, reproducible builds, minimal permissions, and fast feedback loops.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'Actions workflow syntax', 'url': 'https://docs.github.com/actions/writing-workflows/workflow-syntax-for-github-actions', 'note': 'Workflow keys and behavior.'}
]
