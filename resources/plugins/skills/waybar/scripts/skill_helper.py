#!/usr/bin/env python3
"""Utility helper for the waybar skill."""
...
SKILL_NAME = 'waybar'
SKILL_CATEGORY = 'Waybar'
SKILL_DESCRIPTION = 'Configure Waybar modules, styles, and helper scripts with restart-safe behavior and minimal shell exposure. Use when the user asks about Waybar JSON/CSS, custom modules, or bar startup sequencing.'
...
REFERENCE_LINKS = [
  {
    "title": "https://github.com/Alexays/Waybar",
    "url": "https://github.com/Alexays/Waybar",
    "note": "Primary reference."
  },
  {
    "title": "https://github.com/Alexays/Waybar/wiki",
