#!/usr/bin/env python3
"""Utility helper for the obs-kibana skill.
...
SKILL_NAME = 'obs-kibana'
SKILL_CATEGORY = 'OBS'
SKILL_DESCRIPTION = 'Configure Kibana spaces, roles, and dashboards safely.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'Kibana docs', 'url': 'https://www.elastic.co/guide/en/kibana/current/index.html', 'note': 'Space, role, and dashboard administration.'}
]
