#!/usr/bin/env python3
"""Utility helper for the secops-aide skill.
...
SKILL_NAME = 'secops-aide'
SKILL_CATEGORY = 'SECOPS'
SKILL_DESCRIPTION = 'Configure AIDE file integrity monitoring.'
...
REFERENCE_LINKS = [
    {'title': 'AIDE man page', 'url': 'https://manpages.debian.org/stable/aide/aide.1.en.html', 'note': 'AIDE rule and check semantics.'}
]
