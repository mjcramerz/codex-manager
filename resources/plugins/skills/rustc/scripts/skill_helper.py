#!/usr/bin/env python3
"""Utility helper for the rustc skill."""
...
SKILL_NAME = 'rustc'
SKILL_CATEGORY = 'rustc'
SKILL_DESCRIPTION = 'Reason about `rustc` compiler behavior, target triples, and code generation boundaries without hiding them behind ad-hoc shell wrappers. Use when the user asks about compiler flags, target support, or Rust build debugging.'
...
REFERENCE_LINKS = [
  {
    "title": "https://doc.rust-lang.org/rustc/",
    "url": "https://doc.rust-lang.org/rustc/",
    "note": "Primary reference."
  },
  {
    "title": "https://github.com/rust-lang/rust",
