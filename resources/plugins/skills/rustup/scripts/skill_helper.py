#!/usr/bin/env python3
"""Utility helper for the rustup skill."""
...
SKILL_NAME = 'rustup'
SKILL_CATEGORY = 'rustup'
SKILL_DESCRIPTION = 'Manage Rust toolchains through rustup with explicit channels, components, and per-repo overrides. Use when the user asks about toolchain installation, overrides, or keeping CI/local toolchains aligned.'
...
REFERENCE_LINKS = [
  {
    "title": "https://rust-lang.github.io/rustup/",
    "url": "https://rust-lang.github.io/rustup/",
    "note": "Primary reference."
  },
  {
    "title": "https://github.com/rust-lang/rustup",
