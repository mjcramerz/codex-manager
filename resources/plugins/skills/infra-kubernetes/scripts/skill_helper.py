#!/usr/bin/env python3
"""Utility helper for the infra-kubernetes skill.
...
SKILL_NAME = 'infra-kubernetes'
SKILL_CATEGORY = 'INFRA'
SKILL_DESCRIPTION = 'Build and validate Kubernetes manifests with safe defaults.'
...
REFERENCE_LINKS = [{'title': 'Kubernetes Pod Security Standards', 'url': 'https://kubernetes.io/docs/concepts/security/pod-security-standards/', 'note': 'Baseline/Restricted controls for workload admission and runtime hardening.'}, {'title': 'Kubernetes Deployment docs', 'url': 'https://kubernetes.io/docs/concepts/workloads/controllers/deployment/', 'note': 'Rollout, surge/unavailable behavior, and rollback mechanics.'}, {'title': 'kubectl reference', 'url': 'https://kubernetes.io/docs/reference/kubectl/', 'note': 'Validation, diff, apply, and rollout command semantics.'}]
REQUIRED_REFERENCE_FILES = ['latest-sources.md', 'operations-checklist.md', 'risk-register.md', 'rollout-runbook.md', 'workload-security-baseline.md']
REQUIRED_ASSET_FILES = ['icon-32.png', 'icon-128.png', 'rollback-checklist.md', 'deployment-baseline.yaml', 'networkpolicy-default-deny.yaml']
