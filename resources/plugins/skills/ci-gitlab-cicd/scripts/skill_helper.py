#!/usr/bin/env python3
"""Utility helper for the ci-gitlab-cicd skill.
...
SKILL_NAME = 'ci-gitlab-cicd'
SKILL_CATEGORY = 'GIT'
SKILL_DESCRIPTION = 'Build GitLab CI/CD pipelines with security gates, pinned images, and deterministic tooling.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'GitLab CI YAML reference', 'url': 'https://docs.gitlab.com/ee/ci/yaml/', 'note': 'Deterministic pipeline key definitions.'}
]
