#!/usr/bin/env python3
"""Utility helper for the infra-sysctl skill.
...
SKILL_NAME = 'infra-sysctl'
SKILL_CATEGORY = 'INFRA'
SKILL_DESCRIPTION = 'Apply sysctl tuning with safety and rollback.'
...
REFERENCE_LINKS = [{'title': 'sysctl(8) man page', 'url': 'https://man7.org/linux/man-pages/man8/sysctl.8.html', 'note': 'Command behavior for temporary and persistent kernel parameter changes.'}, {'title': 'Kernel sysctl docs', 'url': 'https://docs.kernel.org/admin-guide/sysctl/index.html', 'note': 'Kernel-owned parameter semantics and category-specific caveats.'}, {'title': 'systemd-sysctl service', 'url': 'https://www.freedesktop.org/software/systemd/man/latest/systemd-sysctl.service.html', 'note': 'Boot-time application order and drop-in file loading behavior.'}]
