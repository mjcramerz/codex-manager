#!/usr/bin/env python3
"""Utility helper for the web-nextjs skill.
...
SKILL_NAME = 'web-nextjs'
SKILL_CATEGORY = 'WEB'
SKILL_DESCRIPTION = 'Build Next.js apps with safe server/client boundaries.'
...
REFERENCE_LINKS = [
    {'title': 'Next.js docs', 'url': 'https://nextjs.org/docs', 'note': 'App Router and runtime model guidance.'},
    {'title': 'Next.js release v16.1.6', 'url': 'https://github.com/vercel/next.js/releases/tag/v16.1.6', 'note': 'Latest stable release baseline for this skill.'},
]
