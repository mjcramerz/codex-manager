#!/usr/bin/env python3
"""Utility helper for the web-react skill.
...
SKILL_NAME = 'web-react'
SKILL_CATEGORY = 'WEB'
SKILL_DESCRIPTION = 'Build React apps with performant component structure.'
...
REFERENCE_LINKS = [
    {'title': 'React docs', 'url': 'https://react.dev/', 'note': 'Canonical React architecture, hooks, and performance guidance.'},
    {'title': 'React release v19.2.4', 'url': 'https://github.com/facebook/react/releases/tag/v19.2.4', 'note': 'Latest stable release baseline for this skill.'},
]
