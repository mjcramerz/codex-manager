#!/usr/bin/env python3
        """Utility helper for the codex-mcp skill."""
        ...
        SKILL_NAME = 'codex-mcp'
        SKILL_CATEGORY = 'CODEX'
        SKILL_DESCRIPTION = 'Work in the codex-mcp repository across config rendering, runtime state, SSH material, Podman launch behavior, and verification flows.'
