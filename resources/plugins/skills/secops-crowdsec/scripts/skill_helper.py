#!/usr/bin/env python3
"""Utility helper for the secops-crowdsec skill.
...
SKILL_NAME = 'secops-crowdsec'
SKILL_CATEGORY = 'SECOPS'
SKILL_DESCRIPTION = 'Configure CrowdSec collections, log sources, and bouncers safely.'
...
REFERENCE_LINKS = [
    {'title': 'CrowdSec docs', 'url': 'https://docs.crowdsec.net/docs/next/getting_started/intro/', 'note': 'CrowdSec engine and parser setup.'},
    {'title': 'CrowdSec parser docs', 'url': 'https://docs.crowdsec.net/docs/next/parsers/format/', 'note': 'Parser tuning and detection flow.'}
]
