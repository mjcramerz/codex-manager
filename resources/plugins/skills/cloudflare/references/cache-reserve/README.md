...
| Enable Cache Reserve for your zone | README.md + [configuration.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/cache-reserve/configuration.md) |
| Use with Workers (understand limitations) | [api.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/cache-reserve/api.md) |
| Setup via SDKs or IaC (TypeScript, Python, Terraform) | [configuration.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/cache-reserve/configuration.md) |
| Optimize costs and debug issues | [patterns.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/cache-reserve/patterns.md) + [gotchas.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/cache-reserve/gotchas.md) |
| Understand eligibility and troubleshoot | [gotchas.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/cache-reserve/gotchas.md) → [patterns.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/cache-reserve/patterns.md) |

**Files:**
- [configuration.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/cache-reserve/configuration.md) - Setup, API, SDKs, and Cache Rules
- [api.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/cache-reserve/api.md) - Purging, monitoring, Workers integration
- [patterns.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/cache-reserve/patterns.md) - Best practices, cost optimization, debugging
- [gotchas.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/cache-reserve/gotchas.md) - Common issues, limitations, troubleshooting

## See Also
- [r2]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/r2/) - Cache Reserve built on R2 storage
- [workers]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers/) - Workers integration with Cache API
