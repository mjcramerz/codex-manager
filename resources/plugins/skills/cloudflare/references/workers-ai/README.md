...
- [configuration.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers-ai/configuration.md) - wrangler.jsonc setup, TypeScript types, bindings, environment variables
- [api.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers-ai/api.md) - env.AI.run(), streaming, function calling, REST API, response types
- [patterns.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers-ai/patterns.md) - RAG with Vectorize, prompt engineering, batching, error handling, caching
- [gotchas.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers-ai/gotchas.md) - Deprecated @cloudflare/ai package, rate limits, pricing, common errors

## See Also

- [vectorize]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/vectorize/) - Vector database for RAG patterns
- [ai-gateway]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/ai-gateway/) - Caching, rate limiting, analytics for AI requests
