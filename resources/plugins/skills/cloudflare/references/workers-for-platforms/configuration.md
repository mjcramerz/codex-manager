...
Deploy HTML/CSS/images with Workers. See [api.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers-for-platforms/api.md#static-assets) for upload process.
...
See [api.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers-for-platforms/api.md) for programmatic deployment via REST API or SDK.
...
Add via API metadata (see [api.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers-for-platforms/api.md#deploy-with-bindings)):
```json
{
  "bindings": [
...
For complete binding type reference, see [bindings]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/bindings/) documentation

See [README.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers-for-platforms/README.md), [api.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers-for-platforms/api.md), [patterns.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers-for-platforms/patterns.md), [gotchas.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers-for-platforms/gotchas.md)
