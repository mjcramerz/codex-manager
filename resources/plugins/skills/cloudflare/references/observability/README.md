...
- [GraphQL Analytics API Reference]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/graphql-api/) - Query Workers metrics, HTTP analytics, and 70+ other datasets via GraphQL
