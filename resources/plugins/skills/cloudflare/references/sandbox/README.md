...
## In This Reference
- [configuration.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/sandbox/configuration.md) - Config, CLI, environment setup
- [api.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/sandbox/api.md) - Programmatic API, testing patterns
- [patterns.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/sandbox/patterns.md) - Common workflows, CI/CD integration
- [gotchas.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/sandbox/gotchas.md) - Issues, limits, best practices

## See Also
- [durable-objects]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/durable-objects/) - Sandbox runs on DO infrastructure
- [containers]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/containers/) - Container runtime fundamentals
- [workers]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers/) - Entry point for sandbox requests
