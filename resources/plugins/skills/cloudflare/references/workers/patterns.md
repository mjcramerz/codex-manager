...
**Production**: Use Hono, itty-router, or Worktop (see [frameworks.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers/frameworks.md))
...
**With Hono**: Use `@hono/zod-validator` for automatic validation (see [frameworks.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers/frameworks.md))
...
Rate limiting: See [Durable Objects]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/durable-objects/README.md)
...
- [Gotchas]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers/gotchas.md) - Common issues
