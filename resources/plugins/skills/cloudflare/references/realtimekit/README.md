...
- [Configuration]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/realtimekit/configuration.md) - Setup, installation, wrangler config
- [API]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/realtimekit/api.md) - Meeting object, REST API, SDK methods
- [Patterns]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/realtimekit/patterns.md) - Common workflows, code examples
- [Gotchas]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/realtimekit/gotchas.md) - Common issues, troubleshooting

## See Also

- [Workers]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers/) - Backend integration
- [D1]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/d1/) - Meeting metadata storage
- [R2]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/r2/) - Recording storage
- [KV]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/kv/) - Session management
