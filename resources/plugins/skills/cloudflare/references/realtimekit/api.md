...
- [Configuration]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/realtimekit/configuration.md) - Setup and installation
- [Patterns]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/realtimekit/patterns.md) - Usage examples
- [README]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/realtimekit/README.md) - Overview and quick start
