...
- [gotchas.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/bot-management/gotchas.md) - Common errors, false positives/negatives, limitations
