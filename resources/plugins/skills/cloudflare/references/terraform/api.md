...
- [Patterns]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/terraform/patterns.md) - Architecture patterns
- [Troubleshooting]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/terraform/gotchas.md) - Common issues
