...
See [patterns.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers-vpc/patterns.md) for multi-chunk reading, error handling, and protocol implementations.
...
- [patterns.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers-vpc/patterns.md) - Real-world protocol implementations
- [configuration.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers-vpc/configuration.md) - Wrangler setup and environment variables
- [gotchas.md]($CODEX_HOME/plugins/cache/codex-local/cloudflare-workers/local/skills/cloudflare/references/workers-vpc/gotchas.md) - Limits and error handling
