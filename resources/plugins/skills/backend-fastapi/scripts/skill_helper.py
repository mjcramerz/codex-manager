#!/usr/bin/env python3
"""Utility helper for the backend-fastapi skill.
...
SKILL_NAME = 'backend-fastapi'
SKILL_CATEGORY = 'WEB'
SKILL_DESCRIPTION = 'FastAPI production patterns: configuration, routing, validation, auth hooks, error handling, and testing with secure defaults.'
...
REFERENCE_LINKS = [
    {'title': 'FastAPI docs', 'url': 'https://fastapi.tiangolo.com/', 'note': 'Framework patterns and API wiring.'},
    {'title': 'Pydantic docs', 'url': 'https://docs.pydantic.dev/latest/', 'note': 'Validation and schema serialization patterns.'}
]
