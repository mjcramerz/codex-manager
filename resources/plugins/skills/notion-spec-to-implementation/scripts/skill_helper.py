#!/usr/bin/env python3
"""Utility helper for the notion-spec-to-implementation skill.
...
SKILL_CATEGORY = 'NOTE'
SKILL_DESCRIPTION = 'Turn Notion specs into implementation plans, tasks, and progress tracking; use when implementing PRDs/feature specs and creating Notion plans + tasks from them.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'Notion block API', 'url': 'https://developers.notion.com/reference/block', 'note': 'Spec decomposition and structured task mapping.'}
]
