#!/usr/bin/env python3
"""Utility helper for the desktop-mullvad-browser skill.
...
SKILL_NAME = 'desktop-mullvad-browser'
SKILL_CATEGORY = 'DESKTOP'
SKILL_DESCRIPTION = 'Configure Mullvad Browser safely.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'Mullvad Browser docs', 'url': 'https://mullvad.net/en/browser', 'note': 'Product baseline and hardening defaults.'}
]
