#!/usr/bin/env python3
"""Utility helper for the secops-auditd skill.
...
SKILL_NAME = 'secops-auditd'
SKILL_CATEGORY = 'SECOPS'
SKILL_DESCRIPTION = 'Configure auditd rules and logging safely.'
...
REFERENCE_LINKS = [
    {'title': 'auditd man page', 'url': 'https://man7.org/linux/man-pages/man8/auditd.8.html', 'note': 'Audit daemon behavior and lifecycle controls.'}
]
