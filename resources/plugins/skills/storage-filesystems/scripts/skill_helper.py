#!/usr/bin/env python3
"""Utility helper for the storage-filesystems skill.
...
SKILL_NAME = 'storage-filesystems'
SKILL_CATEGORY = 'INFRA'
SKILL_DESCRIPTION = 'Safe filesystem planning: partitioning, mkfs, mounting, and fstab with explicit confirmation and rollback.'
LAST_REFRESH_UTC = '2026-02-11'
COVERAGE_HEADINGS = ['Use this skill when', 'Safety rules (non-negotiable)', 'Workflow', 'Agent orchestration', 'Validation and testing', 'Outputs', 'References']
REFERENCE_LINKS = [{'title': 'fstab man page', 'url': 'https://man7.org/linux/man-pages/man5/fstab.5.html', 'note': 'Filesystem mount table schema and semantics.'}, {'title': 'mount man page', 'url': 'https://man7.org/linux/man-pages/man8/mount.8.html', 'note': 'Mount options and lifecycle operations.'}]
