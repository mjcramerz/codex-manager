#!/usr/bin/env python3
"""Utility helper for the debian-preseed skill."""
...
SKILL_NAME = 'debian-preseed'
SKILL_CATEGORY = 'Debian Preseed'
SKILL_DESCRIPTION = 'Plan and review Debian preseed repositories with class manifests, destructive-storage safeguards, and staged installer hooks. Use when the user asks about unattended Debian installs, preseed class selection, or installer delivery contracts.'
...
REFERENCE_LINKS = [
  {
    "title": "https://www.debian.org/releases/stable/amd64/apbs04.en.html",
    "url": "https://www.debian.org/releases/stable/amd64/apbs04.en.html",
    "note": "Primary reference."
  },
  {
    "title": "https://wiki.debian.org/DebianInstaller/Preseed",
