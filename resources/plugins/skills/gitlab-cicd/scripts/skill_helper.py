#!/usr/bin/env python3
"""Utility helper for the gitlab-cicd skill."""
...
SKILL_NAME = 'gitlab-cicd'
SKILL_CATEGORY = 'GitLab CI/CD'
SKILL_DESCRIPTION = 'Author and review GitLab CI/CD pipelines that stay thin over shared include contracts, protected refs, runner tags, and release-safe variable policies. Use when the user asks about .gitlab-ci.yml structure, include boundaries, or GitLab delivery hardening.'
...
REFERENCE_LINKS = [
  ...
  {
    "title": "https://docs.gitlab.com/ee/ci/yaml/",
