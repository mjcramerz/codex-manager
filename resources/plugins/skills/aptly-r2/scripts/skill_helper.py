#!/usr/bin/env python3
        """Utility helper for the aptly-r2 skill."""
        ...
        SKILL_NAME = 'aptly-r2'
        SKILL_CATEGORY = 'APT'
        SKILL_DESCRIPTION = 'Work in cf-aptly-r2 and its shared delivery contract across R2 bucket layout, Worker routing, signing assets, and GitLab CI templates.'
