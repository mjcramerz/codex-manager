#!/usr/bin/env python3
"""Utility helper for the infra-proxmox skill.
...
SKILL_NAME = 'infra-proxmox'
SKILL_CATEGORY = 'INFRA'
SKILL_DESCRIPTION = 'Plan Proxmox VM workflows with storage and network safety.'
...
REFERENCE_LINKS = [{'title': 'Proxmox VE QEMU VM docs', 'url': 'https://pve.proxmox.com/pve-docs/chapter-qm.html', 'note': 'VM provisioning, cloud-init, and runtime configuration controls.'}, {'title': 'Proxmox cluster manager docs', 'url': 'https://pve.proxmox.com/pve-docs/chapter-pvecm.html', 'note': 'Cluster quorum and operational safety requirements.'}, {'title': 'Proxmox vzdump docs', 'url': 'https://pve.proxmox.com/pve-docs/chapter-vzdump.html', 'note': 'Backup/restore behavior and rollback-ready backup strategy.'}]
REQUIRED_REFERENCE_FILES = ['cloud-init-golden-image.md', 'latest-sources.md', 'operations-checklist.md', 'proxmox-cluster-ops.md', 'risk-register.md']
REQUIRED_ASSET_FILES = ['icon-32.png', 'icon-128.png', 'rollback-checklist.md', 'cloud-init-user-data.template.yaml', 'vm-spec.template.yaml']
