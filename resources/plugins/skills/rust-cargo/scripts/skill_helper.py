#!/usr/bin/env python3
        """Utility helper for the rust-cargo skill."""
        ...
        SKILL_NAME = 'rust-cargo'
        SKILL_CATEGORY = 'RUST'
        SKILL_DESCRIPTION = 'Edit Rust/Cargo projects with explicit fmt, clippy, test, locked-build, and release packaging guidance.'
