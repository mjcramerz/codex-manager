#!/usr/bin/env python3
"""Utility helper for the obsidian-meeting-intelligence skill.
...
SKILL_NAME = 'obsidian-meeting-intelligence'
SKILL_CATEGORY = 'NOTE'
SKILL_DESCRIPTION = 'Prepare meeting materials and capture outcomes in Obsidian. Use when drafting agendas, pre-reads, decision logs, or follow-up tasks inside an Obsidian vault.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'Obsidian daily notes', 'url': 'https://help.obsidian.md/plugins/daily-notes', 'note': 'Recurring meeting cadence workflows.'}
]
