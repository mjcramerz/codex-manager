#!/usr/bin/env python3
"""Utility helper for the gitops skill."""
...
SKILL_NAME = 'gitops'
SKILL_CATEGORY = 'GitOps'
SKILL_DESCRIPTION = 'Plan GitOps delivery flows with protected refs, environment promotion order, and declarative desired-state review boundaries. Use when the user asks about Git-driven promotion, environment repos, or reconciliation-safe delivery contracts.'
...
REFERENCE_LINKS = [
  {
    "title": "https://opengitops.dev/",
    "url": "https://opengitops.dev/",
    "note": "Primary reference."
  },
  {
    "title": "https://github.com/open-gitops/documents",
