#!/usr/bin/env python3
"""Utility helper for the wofi skill."""
...
SKILL_NAME = 'wofi'
SKILL_CATEGORY = 'Wofi'
SKILL_DESCRIPTION = 'Configure Wofi launchers with deterministic search, style, and command invocation rules. Use when the user asks about Wofi themes, launcher entries, or command safety in desktop launch flows.'
...
REFERENCE_LINKS = [
  {
    "title": "https://hg.sr.ht/~scoopta/wofi",
    "url": "https://hg.sr.ht/~scoopta/wofi",
    "note": "Primary reference."
  },
  {
    "title": "https://man.archlinux.org/man/wofi.7.en",
    "url": "https://man.archlinux.org/man/wofi.7.en",
    "note": "Primary reference."
  }
]
