#!/usr/bin/env python3
"""Validate documented scope for NetHunter Pixel 9a operations."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate NetHunter scope")
    ...
    try:
        ...
        if not all(isinstance(op, str) and op in ALLOWED_OPERATIONS for op in allowed_ops):
        ...
        expires = parse_utc_timestamp(expires_raw)
