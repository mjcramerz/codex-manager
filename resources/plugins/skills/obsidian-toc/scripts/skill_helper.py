#!/usr/bin/env python3
"""Utility helper for the obsidian-toc skill.
...
SKILL_NAME = 'obsidian-toc'
SKILL_CATEGORY = 'NOTE'
SKILL_DESCRIPTION = 'Generate or update a table of contents for Obsidian Markdown notes. Use when a note needs a consistent TOC or when headings have changed.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'Markdown heading syntax', 'url': 'https://www.markdownguide.org/basic-syntax/#headings', 'note': 'Heading patterns for deterministic TOC generation.'}
]
