#!/usr/bin/env python3
"""Utility helper for the secops-usbguard skill.
...
SKILL_NAME = 'secops-usbguard'
SKILL_CATEGORY = 'SECOPS'
SKILL_DESCRIPTION = 'Configure USBGuard rules and policies.'
...
REFERENCE_LINKS = [
    {'title': 'USBGuard docs', 'url': 'https://usbguard.github.io/', 'note': 'Policy and device allowlist guidance.'}
]
