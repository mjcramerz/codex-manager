#!/usr/bin/env python3
"""Utility helper for the infra-virsh skill.
...
SKILL_NAME = 'infra-virsh'
SKILL_CATEGORY = 'INFRA'
SKILL_DESCRIPTION = 'Manage libvirt/KVM workflows with virsh safely.'
...
REFERENCE_LINKS = [{'title': 'libvirt virsh man page', 'url': 'https://www.libvirt.org/manpages/virsh.html', 'note': 'Lifecycle commands, validation options, and state transitions.'}, {'title': 'libvirt domain XML format', 'url': 'https://libvirt.org/formatdomain.html', 'note': 'Authoritative domain XML schema and device modeling behavior.'}, {'title': 'libvirt storage pools', 'url': 'https://libvirt.org/storage.html', 'note': 'Storage pool/volume lifecycle semantics and safety constraints.'}]
REQUIRED_REFERENCE_FILES = ['domain-xml-guardrails.md', 'latest-sources.md', 'operations-checklist.md', 'risk-register.md', 'storage-network-playbook.md']
REQUIRED_ASSET_FILES = ['icon-32.png', 'icon-128.png', 'rollback-checklist.md', 'domain-template.xml', 'network-template.xml']
