#!/usr/bin/env python3
"""Utility helper for the infra-containers skill.
...
SKILL_NAME = 'infra-containers'
SKILL_CATEGORY = 'INFRA'
SKILL_DESCRIPTION = 'Container and virtualization workflows: rootless Docker/Podman, Docker Compose, Buildx/Buildah, and VM scaffolds with explicit network controls.'
LAST_REFRESH_UTC = '2026-02-25'
COVERAGE_HEADINGS = ['Use this skill when', 'Non-negotiables', 'Procedure (high level)', 'Templates', 'Assets', 'Checkpoint gates', 'Agent orchestration', 'Validation and testing', 'References', 'Docs', 'Outputs']
REFERENCE_LINKS = [{'title': 'Docker rootless mode', 'url': 'https://docs.docker.com/engine/security/rootless/', 'note': 'Rootless daemon constraints, contexts, and troubleshooting.'}, {'title': 'Docker Build docs', 'url': 'https://docs.docker.com/build/', 'note': 'BuildKit/Buildx patterns, multi-arch, and secure build primitives.'}, {'title': 'Compose file reference', 'url': 'https://docs.docker.com/reference/compose-file/', 'note': 'Current Compose schema and security-relevant service options.'}, {'title': 'Podman docs', 'url': 'https://docs.podman.io/en/latest/', 'note': 'Rootless behavior, networking limits, and CLI parity notes.'}]
REQUIRED_REFERENCE_FILES = ['build-reproducibility.md', 'compose-security-checklist.md', 'dev-container-checklist.md', 'dockerfile-checklist.md', 'engine-selection.md', 'latest-sources.md', 'operations-checklist.md', 'risk-register.md', 'rootless-checklist.md', 'runtime-security-matrix.md']
REQUIRED_ASSET_FILES = ['icon-32.png', 'icon-128.png', 'rollback-checklist.md', 'docker-bake.hcl', 'security-baseline.compose.override.yml']
