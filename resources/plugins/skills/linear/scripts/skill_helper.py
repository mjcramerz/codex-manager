#!/usr/bin/env python3
"""Utility helper for the pm-linear-issues skill.
...
SKILL_NAME = 'pm-linear-issues'
SKILL_CATEGORY = 'WORKSPACE'
SKILL_DESCRIPTION = 'Manage issues, projects, and team workflows in Linear. Use when the user wants to read, create, or update tickets in Linear.'
...
REFERENCE_LINKS = [
    {'title': 'Linear API docs', 'url': 'https://developers.linear.app/docs/graphql/working-with-the-graphql-api', 'note': 'Linear GraphQL workflow reference.'},
    {'title': 'Linear API auth docs', 'url': 'https://developers.linear.app/docs/graphql/authentication', 'note': 'Authentication and token handling for Linear workflows.'}
]
