#!/usr/bin/env python3
"""Utility helper for the obsidian-knowledge-capture skill.
...
SKILL_NAME = 'obsidian-knowledge-capture'
SKILL_CATEGORY = 'NOTE'
SKILL_DESCRIPTION = 'Capture conversations and decisions into structured Obsidian notes. Use when converting chats, specs, or notes into reusable knowledge artifacts inside an Obsidian vault.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'Obsidian templates', 'url': 'https://help.obsidian.md/plugins/templates', 'note': 'Templated knowledge capture workflows.'}
]
