#!/usr/bin/env python3
"""Utility helper for the web-sveltekit skill.
...
SKILL_NAME = 'web-sveltekit'
SKILL_CATEGORY = 'WEB'
SKILL_DESCRIPTION = 'Build SvelteKit apps with clear routing and adapters.'
...
REFERENCE_LINKS = [
    {'title': 'SvelteKit docs', 'url': 'https://svelte.dev/docs/kit', 'note': 'Canonical routing/load/action guidance.'},
    {'title': 'SvelteKit release @sveltejs/kit@2.53.1', 'url': 'https://github.com/sveltejs/kit/releases/tag/%40sveltejs%2Fkit%402.53.1', 'note': 'Latest package release baseline for this skill.'},
]
