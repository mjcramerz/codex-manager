#!/usr/bin/env python3
"""Utility helper for the desktop-wayland skill.
...
SKILL_NAME = 'desktop-wayland'
SKILL_CATEGORY = 'DESKTOP'
SKILL_DESCRIPTION = 'Configure a minimal Wayland/Labwc desktop stack.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'labwc project', 'url': 'https://github.com/labwc/labwc', 'note': 'Labwc configuration and compositor details.'}
]
