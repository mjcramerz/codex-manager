#!/usr/bin/env python3
"""Utility helper for the infra-systemd skill.
...
SKILL_NAME = 'infra-systemd'
SKILL_CATEGORY = 'INFRA'
SKILL_DESCRIPTION = 'Design and harden systemd services and timers with safe defaults, validation, and install steps.'
...
REFERENCE_LINKS = [{'title': 'systemd.exec', 'url': 'https://www.freedesktop.org/software/systemd/man/latest/systemd.exec.html', 'note': 'Sandboxing, process credentials, and filesystem permission controls.'}, {'title': 'systemd.service', 'url': 'https://www.freedesktop.org/software/systemd/man/latest/systemd.service.html', 'note': 'Service lifecycle semantics and restart behavior.'}, {'title': 'systemd.timer', 'url': 'https://www.freedesktop.org/software/systemd/man/latest/systemd.timer.html', 'note': 'Scheduling, jitter, and persistence behavior for timer units.'}, {'title': 'systemd-analyze', 'url': 'https://www.freedesktop.org/software/systemd/man/latest/systemd-analyze.html', 'note': 'Verification and security scoring workflows.'}]
REQUIRED_REFERENCE_FILES = ['latest-sources.md', 'operations-checklist.md', 'risk-register.md']
REQUIRED_ASSET_FILES = ['icon-32.png', 'icon-128.png', 'rollback-checklist.md']
