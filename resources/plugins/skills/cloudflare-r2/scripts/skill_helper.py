#!/usr/bin/env python3
"""Utility helper for the cloudflare-r2 skill."""
...
SKILL_CATEGORY = 'Cloudflare R2'
SKILL_DESCRIPTION = 'Operate Cloudflare R2-backed publication and artifact delivery paths with explicit bucket, prefix, credential, and immutability rules. Use when the user asks about R2 storage behavior, signed access, or artifact publication through Cloudflare.'
...
REFERENCE_LINKS = [
  {
    "title": "https://developers.cloudflare.com/r2/",
    "url": "https://developers.cloudflare.com/r2/",
    "note": "Primary reference."
  },
  {
    "title": "https://github.com/cloudflare/cloudflare-docs/tree/production/products/r2",
    "url": "https://github.com/cloudflare/cloudflare-docs/tree/production/products/r2",
    "note": "Primary reference."
  }
]
