#!/usr/bin/env python3
"""Utility helper for the desktop-librewolf skill.
...
SKILL_NAME = 'desktop-librewolf'
SKILL_CATEGORY = 'DESKTOP'
SKILL_DESCRIPTION = 'Configure LibreWolf with hardened defaults.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'LibreWolf docs', 'url': 'https://librewolf.net/docs/settings', 'note': 'LibreWolf configuration and policy guidance.'}
]
