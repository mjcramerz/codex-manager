#!/usr/bin/env python3
"""Utility helper for the infra-virtualization skill.
...
SKILL_NAME = 'infra-virtualization'
SKILL_CATEGORY = 'INFRA'
SKILL_DESCRIPTION = 'VM-based virtualization workflows: QEMU/KVM/libvirt, Vagrant, networking modes, and reproducible dev environments.'
LAST_REFRESH_UTC = '2026-02-25'
COVERAGE_HEADINGS = ['Use this skill when', 'Non-negotiables', 'Workflow', 'Checkpoint gates', 'Agent orchestration', 'Validation and testing', 'Outputs', 'References']
REFERENCE_LINKS = [{'title': 'QEMU documentation', 'url': 'https://www.qemu.org/docs/master/', 'note': 'Hypervisor behavior, device model options, and runtime controls.'}, {'title': 'libvirt docs', 'url': 'https://libvirt.org/docs.html', 'note': 'Host capability checks, network/storage primitives, and VM XML orchestration.'}, {'title': 'Vagrant docs', 'url': 'https://developer.hashicorp.com/vagrant/docs', 'note': 'Reproducible VM workflow commands and provider behavior.'}]
REQUIRED_REFERENCE_FILES = ['latest-sources.md', 'networking-modes.md', 'operations-checklist.md', 'provider-decision-matrix.md', 'risk-register.md']
REQUIRED_ASSET_FILES = ['icon-32.png', 'icon-128.png', 'rollback-checklist.md', 'Vagrantfile.template', 'topology.template.yaml']
