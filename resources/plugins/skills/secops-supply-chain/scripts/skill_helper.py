#!/usr/bin/env python3
"""Utility helper for the secops-supply-chain skill.
...
SKILL_NAME = 'secops-supply-chain'
SKILL_CATEGORY = 'SECOPS'
SKILL_DESCRIPTION = 'Strengthen dependency hygiene: pinning, lockfiles, audits, SBOMs, CI enforcement, and avoiding dangerous install patterns.'
...
REFERENCE_LINKS = [
    {'title': 'SLSA framework', 'url': 'https://slsa.dev/spec/v1.0/levels', 'note': 'Supply-chain integrity maturity controls.'},
    {'title': 'sigstore documentation', 'url': 'https://docs.sigstore.dev/', 'note': 'Signing and provenance verification workflows.'},
    {'title': 'OpenSSF Scorecard', 'url': 'https://securityscorecards.dev/', 'note': 'Dependency and repository supply-chain checks.'},
    {'title': 'NIST SSDF SP 800-218', 'url': 'https://csrc.nist.gov/pubs/sp/800/218/final', 'note': 'Secure software development supply-chain controls.'}
]
