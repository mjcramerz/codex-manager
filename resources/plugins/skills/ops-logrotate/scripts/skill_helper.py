#!/usr/bin/env python3
"""Utility helper for the ops-logrotate skill.
...
SKILL_NAME = 'ops-logrotate'
SKILL_CATEGORY = 'OBS'
SKILL_DESCRIPTION = 'Design logrotate policies with safe defaults.'
...
REFERENCE_LINKS = [
    {'title': 'Logrotate man page', 'url': 'https://man7.org/linux/man-pages/man8/logrotate.8.html', 'note': 'Log retention and rotation semantics.'},
    {'title': 'logrotate examples', 'url': 'https://github.com/logrotate/logrotate/tree/main/examples', 'note': 'Reference rotation policies for linux distributions.'}
]
