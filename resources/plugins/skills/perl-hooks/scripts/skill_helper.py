#!/usr/bin/env python3
        """Utility helper for the perl-hooks skill."""
        ...
        SKILL_NAME = 'perl-hooks'
        SKILL_CATEGORY = 'HOOK'
        SKILL_DESCRIPTION = 'Edit Perl hook/runtime modules, matcher helpers, and payload transforms with strict validation and deterministic output handling.'
