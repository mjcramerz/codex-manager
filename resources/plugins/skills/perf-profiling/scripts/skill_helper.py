#!/usr/bin/env python3
"""Utility helper for the perf-profiling skill.
...
SKILL_NAME = 'perf-profiling'
SKILL_CATEGORY = 'INFRA'
SKILL_DESCRIPTION = 'Performance engineering playbook: profiling, benchmarking, hot path analysis, safe optimizations, and regression guards.'
LAST_REFRESH_UTC = '2026-02-11'
COVERAGE_HEADINGS = ['Use this skill when', 'Workflow', 'Agent orchestration', 'Validation and testing', 'Deliverables', 'Outputs', 'References']
REFERENCE_LINKS = [{'title': 'Brendan Gregg performance resources', 'url': 'https://www.brendangregg.com/overview.html', 'note': 'Profiling methodologies and troubleshooting workflows.'}, {'title': 'perf tool docs', 'url': 'https://man7.org/linux/man-pages/man1/perf.1.html', 'note': 'Linux perf tooling reference.'}]
