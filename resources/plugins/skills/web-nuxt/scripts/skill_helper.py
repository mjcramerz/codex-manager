#!/usr/bin/env python3
"""Utility helper for the web-nuxt skill.
...
SKILL_NAME = 'web-nuxt'
SKILL_CATEGORY = 'WEB'
SKILL_DESCRIPTION = 'Build Nuxt apps with explicit runtime config.'
...
REFERENCE_LINKS = [
    {'title': 'Nuxt docs', 'url': 'https://nuxt.com/docs/getting-started/introduction', 'note': 'Nuxt framework architecture and conventions.'},
    {'title': 'Nuxt release v4.3.1', 'url': 'https://github.com/nuxt/nuxt/releases/tag/v4.3.1', 'note': 'Latest stable release baseline for this skill.'},
]
