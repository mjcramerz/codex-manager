#!/usr/bin/env python3
"""Utility helper for the notion-meeting-intelligence skill.
...
SKILL_CATEGORY = 'NOTE'
SKILL_DESCRIPTION = 'Prepare meeting materials with Notion context and Codex research; use when gathering context, drafting agendas/pre-reads, and tailoring materials to attendees.'
...
REFERENCE_LINKS = [
    {'title': 'Notion API intro', 'url': 'https://developers.notion.com/reference/intro', 'note': 'Notion integration behavior and limits.'},
    {'title': 'Notion database query API', 'url': 'https://developers.notion.com/reference/post-database-query', 'note': 'Meeting note retrieval and synthesis workflow inputs.'}
]
