...
## In This Reference
- [configuration.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/agents-sdk/configuration.md) - SDK setup, wrangler config, routing
- [api.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/agents-sdk/api.md) - Agent classes, lifecycle, client hooks
- [patterns.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/agents-sdk/patterns.md) - Common workflows, best practices
- [gotchas.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/agents-sdk/gotchas.md) - Common issues, limits
