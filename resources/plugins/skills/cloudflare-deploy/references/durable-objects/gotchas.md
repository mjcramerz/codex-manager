...
**Solution:** Shard across multiple DOs (see [Patterns: Sharding]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/durable-objects/patterns.md))
...
- **[Patterns]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/durable-objects/patterns.md)** - Workarounds for common limitations
- **[API]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/durable-objects/api.md)** - Storage limits and quotas
- **[Configuration]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/durable-objects/configuration.md)** - Setting CPU limits
