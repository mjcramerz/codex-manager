...
**Solution:** Use bindings instead of REST API in Workers (see $CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/bindings/).
...
- [api.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/api/api.md) - Error types, authentication
- [configuration.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/api/configuration.md) - Timeout/retry configuration
- [patterns.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/api/patterns.md) - Error handling patterns
