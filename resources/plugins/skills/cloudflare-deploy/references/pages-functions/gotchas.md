...
| **Type mismatch on binding** | Wrong interface type | See [api.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/pages-functions/api.md) bindings table for correct types |
...
**See also:** [configuration.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/pages-functions/configuration.md) for TypeScript setup | [patterns.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/pages-functions/patterns.md) for middleware/auth | [api.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/pages-functions/api.md) for bindings
