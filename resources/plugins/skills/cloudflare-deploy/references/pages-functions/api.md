...
**TypeScript:** See [configuration.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/pages-functions/configuration.md) for `wrangler types` setup
...
See [configuration.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/pages-functions/configuration.md) for wrangler.jsonc examples.
...
**See also:** [configuration.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/pages-functions/configuration.md) for TypeScript setup and wrangler.jsonc | [patterns.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/pages-functions/patterns.md) for middleware and auth patterns
