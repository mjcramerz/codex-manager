...
- [r2-data-catalog/configuration.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/r2-data-catalog/configuration.md) - Detailed token setup and PyIceberg connection
