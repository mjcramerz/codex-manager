...
- [r2-data-catalog]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/r2-data-catalog/) - PyIceberg, REST API, external engines
- [pipelines]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/pipelines/) - Streaming ingestion to Iceberg tables
- [r2]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/r2/) - R2 object storage fundamentals
