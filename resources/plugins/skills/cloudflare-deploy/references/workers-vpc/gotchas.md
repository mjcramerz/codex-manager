...
**Solution:** Use [Hyperdrive]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/hyperdrive/) for databases (built-in pooling)
...
|----------|-------------|--------|
| PostgreSQL/MySQL | [Hyperdrive]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/hyperdrive/) | Connection pooling, caching |
...
- [Hyperdrive]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/hyperdrive/) - Database connections
- [Smart Placement]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/smart-placement/) - Latency optimization
- [Tunnel Troubleshooting]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/tunnel/gotchas.md)
