...
For detailed Tunnel setup, see [Tunnel configuration reference]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/tunnel/configuration.md).
...
Workers automatically relocate closer to TCP socket destinations after observing connection latency. See [Smart Placement reference]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/smart-placement/).
...
See [Hyperdrive reference]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/hyperdrive/) for complete setup.
...
- **[Tunnel Configuration]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/tunnel/configuration.md)** - Detailed cloudflared setup
- **[Smart Placement]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/smart-placement/configuration.md)** - Placement mode options
- **[Hyperdrive]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/hyperdrive/configuration.md)** - Database connection pooling setup
