...
- [configuration.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/r2/configuration.md) - Bindings, S3 SDK, CORS, lifecycles, token scopes
- [api.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/r2/api.md) - Workers API, multipart, conditional requests, presigned URLs
- [patterns.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/r2/patterns.md) - Streaming, caching, client uploads, public buckets
- [gotchas.md]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/r2/gotchas.md) - List truncation, etag format, stream length, S3 SDK region
...
- [kv]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/kv/) - Metadata storage for R2 objects
- [d1]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/d1/) - Store R2 URLs in relational database
- [queues]($CODEX_HOME/plugins/cache/codex-local/wrangler/local/skills/cloudflare-deploy/references/queues/) - Process R2 uploads asynchronously
