#!/usr/bin/env python3
"""Utility helper for the crystal-dock skill."""
...
SKILL_NAME = 'crystal-dock'
SKILL_CATEGORY = 'Crystal Dock'
SKILL_DESCRIPTION = 'Coordinate Crystal Dock startup, restart, and PID-file behavior with explicit session ownership and bounded stop or retry handling. Use when the user asks about Crystal Dock launchers, restart helpers, PID files, or Labwc dock integration.'
...
REFERENCE_LINKS = [
  {
    "title": "$CODEX_HOME/docs/workflows/crystal-dock.md",
    "url": "$CODEX_HOME/docs/workflows/crystal-dock.md",
    "note": "Runtime workflow entrypoint."
  },
  {
    "title": "$CODEX_HOME/docs/desktop/crystal-dock.md",
    "url": "$CODEX_HOME/docs/desktop/crystal-dock.md",
    "note": "Runtime desktop guide."
  }
]
