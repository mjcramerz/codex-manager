#!/usr/bin/env python3
"""Utility helper for the obsidian-research-documentation skill.
...
SKILL_NAME = 'obsidian-research-documentation'
SKILL_CATEGORY = 'NOTE'
SKILL_DESCRIPTION = 'Research across sources and synthesize into structured Obsidian documentation. Use when producing briefs, comparisons, or research reports in an Obsidian vault.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'Obsidian links', 'url': 'https://help.obsidian.md/links', 'note': 'Bidirectional linking and research traceability.'}
]
