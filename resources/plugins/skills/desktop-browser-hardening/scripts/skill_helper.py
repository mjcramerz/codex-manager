#!/usr/bin/env python3
"""Utility helper for the desktop-browser-hardening skill.
...
SKILL_NAME = 'desktop-browser-hardening'
SKILL_CATEGORY = 'DESKTOP'
SKILL_DESCRIPTION = 'Harden desktop browsers and profile policies.'
...
REFERENCE_LINKS = [
    {'title': 'Freedesktop Desktop Entry Specification', 'url': 'https://specifications.freedesktop.org/desktop-entry-spec/latest/', 'note': 'Desktop launcher schema and semantics.'},
    {'title': 'Wayland project', 'url': 'https://wayland.freedesktop.org/', 'note': 'Wayland protocol and compositor context.'},
    {'title': 'Mozilla Policy Templates', 'url': 'https://mozilla.github.io/policy-templates/', 'note': 'Browser enterprise hardening policy options.'},
    {'title': 'Firefox enterprise support', 'url': 'https://support.mozilla.org/en-US/kb/customizing-firefox-using-policiesjson', 'note': 'Policy examples for browser hardening.'}
]
