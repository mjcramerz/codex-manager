#!/usr/bin/env python3
"""Utility helper for the openai-docs skill.
...
SKILL_DESCRIPTION = 'Use when the user asks how to build with OpenAI products or APIs and needs up-to-date official documentation with citations (for example: Codex, Responses API, Chat Completions, Apps SDK, Agents SDK, Realtime, model capabilities or limits); prioritize OpenAI docs MCP tools and restrict any fallback browsing to official OpenAI domains.'
...
REFERENCE_LINKS = [
    {'title': 'OpenAI docs home', 'url': 'https://developers.openai.com/docs', 'note': 'Official OpenAI platform documentation.'},
    {'title': 'OpenAI API reference', 'url': 'https://developers.openai.com/docs/api-reference', 'note': 'Endpoints and payload schemas.'},
    {'title': 'OpenAI MCP guide', 'url': 'https://developers.openai.com/docs/mcp', 'note': 'MCP usage in OpenAI ecosystem.'}
]
