#!/usr/bin/env python3
"""Utility helper for the notion-knowledge-capture skill.
...
SKILL_CATEGORY = 'NOTE'
SKILL_DESCRIPTION = 'Capture conversations and decisions into structured Notion pages; use when turning chats/notes into wiki entries, how-tos, decisions, or FAQs with proper linking.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'Notion writing to API', 'url': 'https://developers.notion.com/reference/post-page', 'note': 'Page creation and structured note capture APIs.'}
]
