#!/usr/bin/env python3
"""Utility helper for the notion-research-documentation skill.
...
SKILL_CATEGORY = 'NOTE'
SKILL_DESCRIPTION = 'Research across Notion and synthesize into structured documentation; use when gathering info from multiple Notion sources to produce briefs, comparisons, or reports with citations.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'Notion search API', 'url': 'https://developers.notion.com/reference/post-search', 'note': 'Cross-source research retrieval patterns.'}
]
