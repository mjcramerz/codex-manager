#!/usr/bin/env python3
"""Utility helper for the iac-ansible skill.
...
SKILL_NAME = 'iac-ansible'
SKILL_CATEGORY = 'INFRA'
SKILL_DESCRIPTION = 'Build idempotent Ansible playbooks and roles safely.'
...
REFERENCE_LINKS = [{'title': 'Ansible documentation', 'url': 'https://docs.ansible.com/', 'note': 'Automation and idempotent provisioning patterns.'}, {'title': 'Ansible best practices', 'url': 'https://docs.ansible.com/ansible/latest/playbook_guide/index.html', 'note': 'Role layout and idempotency patterns.'}]
