#!/usr/bin/env python3
"""Utility helper for the desktop-thorium skill.
...
SKILL_NAME = 'desktop-thorium'
SKILL_CATEGORY = 'DESKTOP'
SKILL_DESCRIPTION = 'Plan and validate Thorium Browser builds.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'Thorium release repository', 'url': 'https://github.com/Alex313031/thorium/releases', 'note': 'Version and release validation.'}
]
