#!/usr/bin/env python3
"""Utility helper for the iac-terraform skill.
...
SKILL_NAME = 'iac-terraform'
SKILL_CATEGORY = 'INFRA'
SKILL_DESCRIPTION = 'Plan and review Terraform changes with safe defaults.'
...
REFERENCE_LINKS = [{'title': 'Terraform docs', 'url': 'https://developer.hashicorp.com/terraform/docs', 'note': 'Infrastructure as code workflows and state handling.'}, {'title': 'Terraform style conventions', 'url': 'https://developer.hashicorp.com/terraform/language/style', 'note': 'Readable and deterministic Terraform code.'}]
