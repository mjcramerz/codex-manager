#!/usr/bin/env python3
"""Utility helper for the obsidian-spec-to-implementation skill.
...
SKILL_NAME = 'obsidian-spec-to-implementation'
SKILL_CATEGORY = 'NOTE'
SKILL_DESCRIPTION = 'Convert specs into implementation plans and task notes in Obsidian. Use when turning PRDs or feature specs into plans, checklists, and linked tasks in an Obsidian vault.'
...
REFERENCE_LINKS = [
    {'title': 'Obsidian help', 'url': 'https://help.obsidian.md/', 'note': 'Obsidian Markdown and vault workflow references.'},
    {'title': 'Obsidian canvas', 'url': 'https://help.obsidian.md/plugins/canvas', 'note': 'Visual mapping for specs and tasks.'}
]
