#!/usr/bin/env python3
"""Utility helper for the obs-elasticsearch skill.
...
SKILL_NAME = 'obs-elasticsearch'
SKILL_CATEGORY = 'OBS'
SKILL_DESCRIPTION = 'Configure Elasticsearch safely with retention and access controls.'
...
REFERENCE_LINKS = [
    {'title': 'Elastic docs', 'url': 'https://www.elastic.co/docs', 'note': 'Elasticsearch, Logstash, and Kibana platform docs.'},
    {'title': 'Elasticsearch configuration', 'url': 'https://www.elastic.co/guide/en/elasticsearch/reference/current/settings.html', 'note': 'Cluster and node configuration controls.'}
]
