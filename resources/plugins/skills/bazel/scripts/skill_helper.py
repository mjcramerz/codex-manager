#!/usr/bin/env python3
"""Utility helper for the bazel skill."""
...
SKILL_NAME = 'bazel'
SKILL_CATEGORY = 'Bazel'
SKILL_DESCRIPTION = 'Plan Bazel build and test workflows with hermetic toolchains, cache discipline, and CI-safe remote execution boundaries. Use when the user asks about Bazel commands, CI wiring, or repository/runner layout for Bazel workloads.'
...
REFERENCE_LINKS = [
  {
    "title": "https://bazel.build/",
    "url": "https://bazel.build/",
    "note": "Primary reference."
  },
  {
    "title": "https://github.com/bazelbuild/bazel",
