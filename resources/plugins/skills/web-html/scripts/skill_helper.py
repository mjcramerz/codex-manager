#!/usr/bin/env python3
"""Utility helper for the web-html skill.
...
SKILL_NAME = 'web-html'
SKILL_CATEGORY = 'WEB'
SKILL_DESCRIPTION = 'Build accessible, semantic HTML pages.'
...
REFERENCE_LINKS = [
    {'title': 'HTML Living Standard', 'url': 'https://html.spec.whatwg.org/multipage/', 'note': 'Canonical semantic and parsing reference.'},
    {'title': 'WCAG 2.2 Recommendation', 'url': 'https://www.w3.org/TR/WCAG22/', 'note': 'Current normative accessibility baseline for audits.'},
]
