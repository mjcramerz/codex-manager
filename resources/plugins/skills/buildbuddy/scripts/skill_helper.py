#!/usr/bin/env python3
"""Utility helper for the buildbuddy skill."""
...
SKILL_NAME = 'buildbuddy'
SKILL_CATEGORY = 'BuildBuddy'
SKILL_DESCRIPTION = 'Design BuildBuddy-backed remote cache and execution workflows with explicit auth, isolation, and fallback behavior. Use when the user asks about BuildBuddy integration, remote execution policy, or Bazel CI acceleration.'
...
REFERENCE_LINKS = [
  {
    "title": "https://www.buildbuddy.io/docs/",
    "url": "https://www.buildbuddy.io/docs/",
    "note": "Primary reference."
  },
  {
    "title": "https://github.com/buildbuddy-io/buildbuddy",
