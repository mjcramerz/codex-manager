#!/usr/bin/env python3
"""Utility helper for the web-htmx skill.
...
SKILL_NAME = 'web-htmx'
SKILL_CATEGORY = 'WEB'
SKILL_DESCRIPTION = 'Build server-driven HTMX pages with minimal JS.'
...
REFERENCE_LINKS = [
    {'title': 'htmx documentation', 'url': 'https://htmx.org/docs/', 'note': 'Core request/response semantics and progressive enhancement patterns.'},
    {'title': 'htmx release v2.0.7', 'url': 'https://github.com/bigskysoftware/htmx/releases/tag/v2.0.7', 'note': 'Latest stable baseline used for this skill.'},
]
