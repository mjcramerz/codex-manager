#!/usr/bin/env python3
"""Utility helper for the backend-axum skill.
...
SKILL_NAME = 'backend-axum'
SKILL_CATEGORY = 'WEB'
SKILL_DESCRIPTION = 'Axum API production patterns: routing, extractors, typed errors, tracing, timeouts, and secure defaults.'
...
REFERENCE_LINKS = [
    {'title': 'Axum crate docs', 'url': 'https://docs.rs/axum/latest/axum/', 'note': 'Router, extractor, and middleware behavior.'},
    {'title': 'Tokio runtime docs', 'url': 'https://docs.rs/tokio/latest/tokio/', 'note': 'Async runtime behavior and task orchestration.'}
]
