#!/usr/bin/env python3
"""Utility helper for the cargo skill."""
...
SKILL_NAME = 'cargo'
SKILL_CATEGORY = 'Cargo'
SKILL_DESCRIPTION = 'Review Cargo workspace configuration, dependency policy, and release command usage with deterministic lockfile and validation defaults. Use when the user asks about Cargo manifests, commands, or CI/release behavior.'
...
REFERENCE_LINKS = [
  ...
  {
    "title": "https://github.com/rust-lang/cargo",
