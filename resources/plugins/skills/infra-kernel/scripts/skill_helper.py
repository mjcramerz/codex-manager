#!/usr/bin/env python3
"""Utility helper for the infra-kernel skill.
...
SKILL_NAME = 'infra-kernel'
SKILL_CATEGORY = 'INFRA'
SKILL_DESCRIPTION = 'Plan and validate custom Linux kernel builds.'
...
REFERENCE_LINKS = [{'title': 'Kernel admin guide', 'url': 'https://docs.kernel.org/admin-guide/README.html', 'note': 'Baseline kernel build/install guidance and admin caveats.'}, {'title': 'Kernel Kbuild docs', 'url': 'https://docs.kernel.org/kbuild/index.html', 'note': 'Build system behavior, targets, and reproducible build controls.'}, {'title': 'Kernel Kconfig docs', 'url': 'https://docs.kernel.org/kbuild/kconfig-language.html', 'note': 'Config semantics for deterministic fragment management.'}]
