#!/usr/bin/env python3
"""Utility helper for the appsec-hardening skill.
...
SKILL_NAME = 'appsec-hardening'
SKILL_CATEGORY = 'AUDIT'
SKILL_DESCRIPTION = 'Practical application security hardening: input validation, auth, safe subprocess, web security headers, and abuse resistance.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'CWE Top 25', 'url': 'https://cwe.mitre.org/top25/archive/2024/2024_key_insights.html', 'note': 'Prioritized weakness classes for reviews.'}
]
