#!/usr/bin/env python3
"""Utility helper for the aptly skill."""
...
SKILL_NAME = 'aptly'
SKILL_CATEGORY = 'Aptly'
SKILL_DESCRIPTION = 'Manage Aptly repositories with deterministic snapshot promotion, signing, cleanup, and publication contracts. Use when the user asks about package publication channels, retention, or managed Aptly service behavior.'
...
REFERENCE_LINKS = [
  {
    "title": "https://www.aptly.info/",
    "url": "https://www.aptly.info/",
    "note": "Primary reference."
  },
  {
    "title": "https://github.com/aptly-dev/aptly",
