#!/usr/bin/env python3
"""Utility helper for the devtools-app-scaffolder skill.
...
SKILL_NAME = 'devtools-app-scaffolder'
SKILL_CATEGORY = 'APPS'
SKILL_DESCRIPTION = 'Scaffold full-fledged apps using the provided templates; wire up config, logging, tests, and CI with secure defaults.'
...
REFERENCE_LINKS = [
    {'title': 'FastAPI documentation', 'url': 'https://fastapi.tiangolo.com/', 'note': 'API scaffolding and validation patterns.'},
    {'title': 'Axum crate documentation', 'url': 'https://docs.rs/axum/latest/axum/', 'note': 'Rust web service composition patterns.'},
    {'title': 'React docs', 'url': 'https://react.dev/', 'note': 'UI component architecture and state patterns.'},
    {'title': 'VS Code extension API', 'url': 'https://code.visualstudio.com/api', 'note': 'Extension APIs and packaging guidance.'},
    {'title': 'PyPI packaging guide', 'url': 'https://packaging.python.org/en/latest/tutorials/packaging-projects/', 'note': 'Python package scaffolding baseline.'},
    {'title': 'Cargo book', 'url': 'https://doc.rust-lang.org/cargo/', 'note': 'Rust workspace and build orchestration details.'}
]
