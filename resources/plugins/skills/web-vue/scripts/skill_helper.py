#!/usr/bin/env python3
"""Utility helper for the web-vue skill.
...
SKILL_NAME = 'web-vue'
SKILL_CATEGORY = 'WEB'
SKILL_DESCRIPTION = 'Build Vue apps with Composition API defaults.'
...
REFERENCE_LINKS = [
    {'title': 'Vue docs', 'url': 'https://vuejs.org/guide/introduction.html', 'note': 'Canonical framework guidance for Composition API and components.'},
    {'title': 'Vue release v3.5.29', 'url': 'https://github.com/vuejs/core/releases/tag/v3.5.29', 'note': 'Latest stable release baseline for this skill.'},
]
