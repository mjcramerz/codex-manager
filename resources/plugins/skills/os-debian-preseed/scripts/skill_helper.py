#!/usr/bin/env python3
"""Utility helper for the os-debian-preseed skill.
...
SKILL_NAME = 'os-debian-preseed'
SKILL_CATEGORY = 'INFRA'
SKILL_DESCRIPTION = 'Create Debian preseed files for unattended installations.'
...
REFERENCE_LINKS = [{'title': 'Debian installer preseed guide', 'url': 'https://www.debian.org/releases/stable/amd64/apbs04.en.html', 'note': 'Preseed directive behavior and examples.'}]
