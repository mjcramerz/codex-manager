#!/usr/bin/env python3
"""Utility helper for the obsidian-docs skill.
...
SKILL_NAME = 'obsidian-docs'
SKILL_CATEGORY = 'NOTE'
SKILL_DESCRIPTION = 'Create, update, and structure Obsidian documentation vaults and notes. Use when organizing knowledge, standardizing frontmatter, building indexes, or applying templates inside an Obsidian vault.'
...
REFERENCE_LINKS = [
    ...
    {'title': 'Obsidian markdown format', 'url': 'https://help.obsidian.md/syntax', 'note': 'Canonical markdown syntax for vault docs.'}
]
